//-------------------------------------------------------------------------------------------------
// <copyright file="BindTransformCommand.cs" company="Outercurve Foundation">
...
namespace WixToolset.Bind
{
    ...
    internal class BindTransformCommand : ICommand
    {
        ...
        public void Execute()
        {
            ...
            {
                extension.Finish(this.Transform);
            }
            ...
            try
            {
                ...
                using (Database targetDatabase = new Database(targetDatabaseFile, OpenDatabase.ReadOnly))
                {
                    using (Database updatedDatabase = new Database(updatedDatabaseFile, OpenDatabase.ReadOnly))
                    {
                        ...
                        {
                            if (null != targetProductCode && !this.NonEmptyProductCodes.Contains(targetProductCode))
                            {
